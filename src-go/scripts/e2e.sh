...
curl -fsS -X POST "http://$SUP_ADDR/v1/supervisor/sandboxes" \
  -H 'content-type: application/json' \
  -d '{"sandbox_id":"sbx-sup","desired_state":"stopped","vm_profile":{"kernel_image":"vmlinux","rootfs_image":"rootfs.img","vcpu":1,"memory_mib":256},"network_policy":{"default_deny":true,"allow":[]},"ttl_seconds":3600}' >/dev/null
