...
|-----------|------------|---------|
| Telegram Connection | Bun (grammY) | Connect to Telegram, send/receive messages |
...
| Runtime | Bun | Host process for routing and scheduling |
...
│
├── container/
│   ├── Dockerfile                 # Container image (runs as 'bun' user, includes Claude Code CLI)
